...
<p align="center">
  ...
  <p align="center"> 
    ...
    <a href="https://github.com/Rutwik1/Weather-App/issues">Report Bug</a>    &#10023;
...
The project repository can be found in [GitHub link](https://github.com/Rutwik1/Weather-App) or just clone the project using this command.

```
Using HTTPS

# git clone  https://github.com/Rutwik1/Weather-App.git
```
